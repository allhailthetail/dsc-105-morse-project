...
mkdir -p ../plots/general
mkdir -p ../plots/waveforms/initial
mkdir -p ../csv/
  #+end_src
...
- Boxplot of the durations:
  #+begin_src R :file plots/general/dur-hist.png :results silent graphics
...
text(x = 20, y = 40, labels = mean_text, col = "black", cex = 1.5)
  ...
  [[file:~/playground/morse-project/plots/general/dur-hist.png][Graphic - File Durations]]
...
summary(basic_metadata$approx_wpm)
  ...
  #+RESULTS:
  : filename samples duration sampleRate stereo  pcm bitdepth           prediction approx_wpm
  : 1 ./data/cw001.wav  139046   17.381       8000  FALSE TRUE       32                 <NA>      13.81
  : 2 ./data/cw002.wav   92953   11.619       8000  FALSE TRUE       32                 <NA>      20.66
  : 3 ./data/cw003.wav   47526    5.941       8000  FALSE TRUE       32                 <NA>      40.40
  : 4 ./data/cw004.wav   59983    7.498       8000  FALSE TRUE       32                 <NA>      32.01
  : 5 ./data/cw005.wav   52381    6.548       8000  FALSE TRUE       32 FEFOFQUHYNZ3WONZRETF      36.65
  : 6 ./data/cw006.wav  113453   14.182       8000  FALSE TRUE       32                 <NA>      16.92
  : Min. 1st Qu.  Median    Mean 3rd Qu.    Max.
  :    8.85   18.15   26.29   26.58   35.60   51.44

  #+begin_src R :file plots/general/wpm-approx.png :results silent graphics
  ...
  [[file:~/playground/morse-project/plots/general/wpm-approx.png][Graphic - Approximate WPMs]]
